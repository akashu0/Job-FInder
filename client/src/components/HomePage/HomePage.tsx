...
function HomePage() {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <img
        src="https://res.cloudinary.com/dptw5t5vn/image/upload/v1694083674/h1_hero_mtolut.jpg"
        alt=""
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:h-96">
          <h2 className="text-6xl font-bold tracking-tight text-blue-900 sm:text-6xl">
            Find the <br /> most exciting <br /> startup jobs
          </h2>
          <p className="mt-6 text-lg leading-8 text-blue-900"></p>
        </div>
