      ...
      <div className="flex justify-center items-center ">
        <div className="p-6 bg-white border border-gray-300 rounded shadow-lg mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <form onSubmit={handleSubmit(submitHandler)} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-3 py-2 text-sm bg-black text-white rounded hover:bg-gray-900 flex justify-center items-center"
            >
              Sign up
            </button>
          </form>
          ...
          <div className="mt-4 text-center">
            <Link to={"/user/login"}>
              <span className="text-gray-500">
                ...
                <p className="text-gray-900 underline">Login</p>
              </span>
            </Link>
          </div>
        </div>
